...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Criptografia de Substituição Simples");

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        jLabel2.setText("Informe a Mensagem a ser Criptografada:");

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        jLabel3.setText("Mensagem Criptografada Cesar:");

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        jLabel4.setText("Mensagem Criptografada Albam:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < palavra.length(); i++) {
            ...
            if (novaPalavra[i] >= 123) {
                jTextField1.setText("" + (char) (novaPalavra[i] - 26));
                }else if (novaPalavra[i] == 35){
                    jTextField1.setText("");
            } else {
                jTextField1.setText("" + (char)(novaPalavra[i]));
                }
